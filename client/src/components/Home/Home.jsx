...
const Home = () => {
  ...
  return (
    ...
    <div className="bg-white justify-center  md:w-full md:max-w-md max-w-sm flex px-4 mt-10 shadow-2xl rounded-xl">
    ...
    <div className="container mx-auto mt-10 px-4">
        ...
        {currentId && <Form currentId={currentId} setCurrentId={setCurrentId} />}
