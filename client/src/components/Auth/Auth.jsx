...
const Auth = () => {
  ...
  return (
    <form class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12" onSubmit={handleSubmit}>
      <div class="p-10 xs:p-0 justify-center mx-auto md:w-full md:max-w-md">
        <div className="mb-5 px-[60px] justify-center items-center">
          <Link to="/projects" className="flex justify-center gap-3">
            <img src={logo} alt="logo" className="w-9 sm:justify-center h-9 object-contain rounded-full" />
        ...
        <div className="mb-5 flex flex-col justify-between items-center">
          <p class="text-gray-700">Only  Club Executives can Login</p>
